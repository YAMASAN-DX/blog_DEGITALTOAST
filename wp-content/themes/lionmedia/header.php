...
<?php endif; ?>
<link rel="shortcut icon" href="//degital-toast.com/wp-content/themes/lionmedia/favicon.ico">

<!--<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>-->
<script data-ad-client="ca-pub-1377865199309872" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
...
})(window,document,'script','dataLayer','GTM-5THM38F');</script>
<!-- End Google Tag Manager --> 
    
	<!-- Global site tag (gtag.js) - Google Ads: 1019773117 -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=AW-1019773117"></script>
	<script>
		window.dataLayer = window.dataLayer || [];
		function gtag(){dataLayer.push(arguments);}
		gtag('js', new Date());
		
		gtag('config', 'AW-1019773117');
    gtag('config', 'G-RC3Z64Q9M3');
	</script>
    
</head>
<body<?php fit_body_class(); ?> itemscope itemtype="https://schema.org/WebPage" >
    
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5THM38F"
...
<?php } ?>
  ...
  <header class="l-header" itemscope itemtype="https://schema.org/WPHeader">
    <div class="container">
      ...
      <nav class="menuNavi" itemscope itemtype="https://schema.org/SiteNavigationElement">      
