...
function custom_caption_code($attr, $content = null) {
    ...
    return '<figure ' . $id . 'class="wp-caption ' . esc_attr($align) . '" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">' . do_shortcode( $content ) . '<figcaption class="wp-caption-text">' . $caption . '</figcaption></figure>';
}
