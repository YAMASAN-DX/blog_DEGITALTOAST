      ...
      <?php if(get_option('fit_theme_articleLayout') == 'value3'): ?> archiveItem-wideSp<?php endif; ?>" itemprop="blogPost" itemscope itemtype="http://schema.org/BlogPosting">
        
        <div class="eyecatch eyecatch-archive">
          <?php if(is_sticky()):?>
            <span class="eyecatch__ribbon">Pickup</span>
          <?php endif;?>
          <span class="eyecatch__cat bgc<?php if (isset($cat_meta[$cat_id])) { echo esc_html($cat_meta[$cat_id]);} ?> u-txtShdw">
			<?php 
        ...
        <ul class="dateList dateList-archive">
          ...
          <li class="dateList__item icon-calendar"><time itemprop="datePublished" datetime="{{YYYY-mm-ddTHH:ii:ss+09:00}}"><?php the_time('Y.m.d'); ?></time></li>
          <?php endif; ?>
          <?php if(has_tag()==true) :  ?>
