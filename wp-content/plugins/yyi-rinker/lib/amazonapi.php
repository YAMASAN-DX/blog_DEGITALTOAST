...
/**
 * change point
 * add class SearchItemsRequest
 * add class GetItemsRequest
 */

/**
 * change log
 * class name AwsV4 → Yyi_Rinker_AwsV4
 * 2021/8/20 Yayoi
 */

class Yyi_Rinker_AwsV4 {
...
class Yyi_Rinker_SearchItemsRequest {
	public $PartnerType;
	public $PartnerTag;
	public $Keywords;
	public $SearchIndex;
...
class Yyi_Rinker_GetItemsRequest {
	public $PartnerType;
	public $PartnerTag;
	public $ItemIds;
	public $Resources;
...
class Yyi_Rinker_CreatorSearchItemsRequest {
    public $partnerType;
    public $partnerTag;
    public $marketplace;
    public $keywords;
...
class Yyi_Rinker_CreatorGetItemsRequest {
    public $partnerType;
    public $partnerTag;
    public $marketplace;
    public $itemIdType;
