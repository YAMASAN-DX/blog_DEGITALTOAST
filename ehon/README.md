...
- `index.html` … お話一覧（本棚）
- `story3d.html?id=momotaro` … 立体版のビューア（1〜8場面）
...
`story3d.html?id=momotaro` は、three.js の立体舞台で読む版です。いまは 1〜8場面（村のふたり → 山と川へ → 桃が流れてくる → 桃太郎の誕生 → 旅立ち → 犬・猿・キジがなかまに）。
9場面目からは、最後のページのリンクで平面の絵本（`story.html#p10`）につながります。一覧のカードの「立体版で読む」からも開けます。
